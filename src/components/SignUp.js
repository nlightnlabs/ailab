...
useEffect(()=>{
  setAppData({})
  setPageName("sign_up")
  setPage(pages.find(x=>x.name==="sign_up"))
  setPageList([...pageList,'sign_up'])
},[])
...
const handleChange = (e)=>{
    ...
    let user_info = { ...formData, ...{ [name]: value } };
      ...
      e.preventDefault();
        ...
        try{
          ...
          if(response =="User Exists"){
            ...
            alert(JSON.stringify(appData.user_info))
...
return (
  <div className="d-flex w-100 justify-content-center">
    ...
    <div className="d-flex flex-column w-100 jusitfy-content-center" style={{maxWidth: "600px", minWidth: "300px"}}>
